...
Lab budget tracking and expenditure management web application.<br>
...
Movie tracking platform and media discovery web application.<br>
...
Smart automated irrigation controller engineered for precision agriculture.<br>
...
Ultrasonic radar detection and spatial mapping system.<br>
...
<img src="./activity.svg?v=5" width="620" alt="Contribution Graph"/>
